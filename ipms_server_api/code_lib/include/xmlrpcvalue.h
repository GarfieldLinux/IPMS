...
//	XmlRpcValue(int value)  : _type(TypeInt) { _value.asInt = value; }
    XmlRpcValue(__int32_t value)  : _type(TypeInt) { _value.asInt = value; }
	XmlRpcValue(__int64_t value)  : _type(TypeInt) { _value.asInt = value; }
...
//	XmlRpcValue& operator=(int const& rhs) { return operator=(XmlRpcValue(rhs)); }
    XmlRpcValue& operator=(__int32_t const& rhs) { return operator=(XmlRpcValue(rhs)); }
	XmlRpcValue& operator=(__int64_t const& rhs) { return operator=(XmlRpcValue(rhs)); }
...
//	operator int&()           { assertTypeOrInvalid(TypeInt); return (int&)_value.asInt; }
	operator __int32_t&()           { assertTypeOrInvalid(TypeInt); return (__int32_t&)_value.asInt; }
	operator __int64_t&()           { assertTypeOrInvalid(TypeInt); return _value.asInt; }
